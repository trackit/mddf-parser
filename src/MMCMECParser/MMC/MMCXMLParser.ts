...
function parsePresentations(doc: Document): MMCInterface['Presentations'] {
  ...
  const presentationList: MMCInterface['Presentations']['Presentation'] = Array.from(presentationElements).map((presentationElement) => {
    ...
    videoTrackReferenceElements.forEach((videoTrackReferenceElement) => {
    ...
    audioTrackReferenceElements.forEach((audioTrackReferenceElement) => {
    ...
    subtitleTrackReferenceElements.forEach((subtitleTrackReferenceElement) => {
